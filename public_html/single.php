...
<!-- HEADER -->
    ...
    <main>
        <div class="image-container">
            <img src="./menu_images/bahn-mi/croissant-mi-parisbanhmi.png" alt="Descriptive Alt Text" class="centered-image">
        </div>

        <!-- TITLE & PRICE | ADD PHP -->
        <div class="info-wrapper">
            <div class="subtotal-container">
                <h3 class="subtotal-title">Title</h3>
                <p class="subtotal-price">Price</p>
            </div>
